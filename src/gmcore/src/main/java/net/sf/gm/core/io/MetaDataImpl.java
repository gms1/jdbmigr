...
public class MetaDataImpl implements MetaData {
     ...
     */
    public final int getRowSetType() {
        return rowSetType;
    }
     ...
     */
    public final boolean isShowDeleted() {
        return showDeleted;
    }
     ...
     */
    public final String getColumnName(int idx) {
     ...
     */
    public final int getColumnScale(int idx) {
        return columnScale[idx - 1];
    }
     ...
     */
    public final int getColumnType(int idx) {
        return columnType[idx - 1];
    }
     ...
     * @return the int
     */
    public final int isColumnNullable(int idx) {
        return 0;
    }
     ...
     */
    public final boolean isColumnSigned(int idx) {
        return columnSigned[idx - 1];
    }
