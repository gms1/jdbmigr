...
public abstract class DataWriterAbstractStream
   ...
   */
  protected rowType getCurrentRowType() { return currentRowType; }
   ...
   * @throws DataIOException the data IO exception
   */
  public void endRowWriting() throws DataIOException { processedRowCount++; }
   ...
   */
  protected OutputStream getOutputStream() { return os; }
   ...
   */
  protected int getColumnCount() { return colCount; }
   ...
   */
  public long getRowFailedCount() { return 0; }
   ...
   */
  public long getRowIgnoredCount() { return 0; }
   ...
   */
  public long getRowProcessedCount() { return processedRowCount; }
   ...
   */
  public long getRowWrittenCount() { return processedRowCount; }
