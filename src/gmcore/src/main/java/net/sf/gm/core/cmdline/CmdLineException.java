...
public class CmdLineException extends Exception {
   ...
   */
  public CmdLineException(final String message) { super(message); }
  ...
  public static class NotEnoughArgumentsException extends CmdLineException {
     ...
     * constructor.
     */
    public NotEnoughArgumentsException() { super("not enough arguments"); }
  }
  ...
  public static class TooManyArguments extends CmdLineException {
     ...
     * constructor.
     */
    public TooManyArguments() { super("to many arguments"); }
  }
  ...
  public static class HelpOptionSelected extends CmdLineException {
     ...
     * constructor.
     */
    public HelpOptionSelected() { super("help option selected"); }
  }
}
