...
//
/**
 * The Class finfexptab.
 */
public class finfexptab extends JDbMigrApplicationBase {
  ...
  protected int runInstance() throws Exception {
    ...
    boolean res;
    if (tableList == null)
      res = exp.process(progress, output, ".finf", unloader, force, catalogName,
                        schemaName, tableName);
    else
      res = exp.process(progress, output, ".finf", unloader, force, tableList);
  ...
  public static void main(final String[] args) {
    ...
    AbstractApplication.runMain(null, "jdbmigr",
                                finfexptab.class.getSimpleName(), null,
                                "gmjdbmigr.version", "gm.jdbmigr.release",
                                finfexptab.class.getName(), args);
  }
}
