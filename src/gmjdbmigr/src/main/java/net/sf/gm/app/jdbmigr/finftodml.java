...
import net.sf.gm.io.xml.FINFWebRowSetReader;

//
/**
 * The Class finftoxml.
 */
public class finftodml extends JDbMigrApplicationBase {
  ...
  protected int runInstance() throws Exception {
    ...
    for (FileFilterItem item : fileList) {
      ...
      try {
        ...
        DataReader reader = new FINFWebRowSetReader(progress, is);
  ...
  public static void main(final String[] args) {
    ...
    AbstractApplication.runMain(null, "jdbmigr",
                                finftodml.class.getSimpleName(), null,
                                "gmjdbmigr.version", "gm.jdbmigr.release",
                                finftodml.class.getName(), args);
  }
}
