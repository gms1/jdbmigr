...
import net.sf.gm.io.xml.FINFWebRowSetReaderFactory;
...
public class finfimptab extends JDbMigrApplicationBase {
    ...
    protected int runInstance() throws Exception {
        ...
        final Importer imp = new ImporterImpl(new FINFWebRowSetReaderFactory());

        boolean res;
        if (tableList == null)
            res = imp.process(progress, input, ".finf", loader, !noSort, doDelete,
    ...
    public static void main(final String[] args) {
        ...
        AbstractApplication.runMain(null, "jdbmigr",
            finfimptab.class.getSimpleName(), null,
            "gmjdbmigr.version", "gm.jdbmigr.release",
            finfimptab.class.getName(), args);
    }
}
